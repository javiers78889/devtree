...
type DevTree = {
    ...
    handleEnableLink: (props: string) => void
}

export default function DevTreeInput({ item, cambio, handleEnableLink }: DevTree,) {
    return (
        <div className="bg-white shadow-sm p-5 flex items-center gap-3">
            ...
            <input type="text" className="flex-1 border border-gray-100 rounded-lg" value={item.url} onChange={cambio} name={item.name} />
            <Switch
